...
if(isset($_POST['submit'])){
	...
	$gift_offer=get_safe_value($con,$_POST['gift_offer']);
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			if($_FILES['image']['name']!=''){
				...
				$update_sql="update product set categories_id='$categories_id',sub_categories_id='$sub_categories_id',name='$name',mrp='$mrp',price='$price',qty='$qty',short_desc='$short_desc',description='$description',best_seller='$best_seller',gift_offer='$gift_offer',meta_title='$meta_title',meta_desc='$meta_desc',meta_keyword='$meta_keyword',image='$image' where id='$id'";
			}else{
			...
			$insert_product=mysqli_query($con,"insert into product(categories_id,sub_categories_id,name,mrp,price,qty,short_desc,description,best_seller,gift_offer,meta_title,meta_desc,meta_keyword,status,image) values('$categories_id','$sub_categories_id','$name','$mrp','$price','$qty','$short_desc','$description','$best_seller','$gift_offer','$meta_title','$meta_desc','$meta_keyword','1','$image')");
					}
		header('location:product.php');
		die();
	}
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
				...
				<div class="form-group">
									<label for="categories" class=" form-control-label">Best Products</label>
								...
								<option>Select Best Seller</option>
									...
									<option value="0" selected>No</option>';										}else{
											echo '
									<option value="1">Yes</option>
									<option value="0">No</option>';
										}
						...
						<div class="form-group">
								...
								<div class="form-group">
									<label for="gift_offer" class=" form-control-label">Off Rate</label>
									<input type="text" name="gift_offer" placeholder="Enter product Gift Offer" class="form-control" required value="<?php echo $gift_offer?>">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<img class="image-responsive mt-2" width="80" height="80" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$image?>">
								</div>
